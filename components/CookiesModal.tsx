        ...
        <div className="fixed desktop:bottom-[97px] desktop:top-auto desktop:inset-auto desktop:right-[60px] flex bottom-[91px] left-[25px] right-[25px] overflow-hidden flex-col min-w-fit min-h-fit desktop:min-w-[676px] desktop:w-[676px] bg-cream text-black rounded-1.25 pt-[39px] desktop:pt-[68px] desktop:pb-[74px] desktop:pl-[72px] desktop:pr-[116px] pb-[31px] pl-[25px] pr-[20px]">
          ...
          <div className="flex flex-col desktop:flex-row desktop:gap-[6px] text-h5">
            <div>
              <Button
                className={
                  "w-full desktop:px-5 font-labgrotesque-light desktop:py-[10px] px-[51px] py-[10px] text-center mb-3 desktop:mb-0 rounded-3xl border-black border-[1px]"
                }
            ...
            <div>
              <Button
                className={
                  "w-full desktop:px-5 font-labgrotesque-light desktop:py-[10px] px-[51px] py-[10px] text-center desktop:mb-0 rounded-3xl border-black border-[1px]"
                }
                onClick={(e: any) => handleClose(e)}
              >
                <p>Reject Cookies</p>
