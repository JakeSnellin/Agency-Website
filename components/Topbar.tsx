...
export default function Topbar() {
    return (
      <header className="topBar h-16 flex items-center justify-between">
        <div className='logo h-logo-height w-logo-width relative inline-block ml-4'><Image className="object-contain" src="/../public/logo3x.png" alt="logo" fill={true} quality={100}/></div>
